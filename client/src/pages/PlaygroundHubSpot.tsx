...
export default function PlaygroundHubSpot() {
  return (
    <PortalLayout title="HubSpot Playground">
      <div className="px-4 lg:px-8 py-6 space-y-6">
        ...
        >
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ opacity: 0.12 }} xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="circuit-hubspot" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#circuit-hubspot)"/>
          </svg>
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              backgroundImage: `url(https://d2xsxph8kpxj0f.cloudfront.net/310519663417013740/gkLpfNMVYQYMxzYT6m74Yk/final-playground-hubspot-3TfQZJmJhFnBKbwjAqBaLG.webp)`,
          ...
          <div className="relative flex flex-col justify-center h-full px-8 py-6 gap-1">
            ...
            <h1 className="text-2xl font-extrabold text-white leading-tight">HubSpot</h1>
            <p className="text-sm text-gray-300 mb-2">Explore WAVV's integration with HubSpot — dialer, call boards, and messenger in a sandbox environment.</p>
          </div>
        </div>
        ...
        >
          ...
          <p className="text-gray-400 text-sm max-w-md leading-relaxed">
            The HubSpot playground environment is currently under development. Check back soon for hands-on sandbox experiences with WAVV inside HubSpot.
          </p>
        </div>
      </div>
    </PortalLayout>
