...
export default function MedalCase({ trigger, externalOpen, onClose }: TrophyCaseProps) {
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-white font-bold text-base">Medals</h2>
                  <p className="text-gray-500 text-xs">{earnedCount} of {totalCount} medals earned</p>
                </div>
              </div>
