      ...
      <div className="flex flex-1 min-h-0">
        ...
        >
          ...
          <nav className="flex-1 px-3 py-4 overflow-y-auto">
            {/* ── Explore ── */}
            <div className="px-3 mb-2"><span className="text-[14px] font-bold tracking-normal text-white uppercase" style={{ textDecoration: "underline", textUnderlineOffset: "6px", textDecorationThickness: "1px" }}>Explore</span></div>
            ...
            {visibleProgramItems.length > 0 && (
              <>
                ...
                <div className="px-3 mb-2"><span className="text-[14px] font-bold tracking-normal text-white uppercase" style={{ textDecoration: "underline", textUnderlineOffset: "6px", textDecorationThickness: "1px" }}>Programs</span></div>
            ...
            {!settingsLoading && (allSettings as Record<string, unknown>)["chrome_extension_enabled"] !== false && (
              <>
                <div className="mx-3 my-4" style={{ borderTop: "1px solid rgba(255,255,255,0.12)" }} />
                <div className="px-3 mb-2"><span className="text-[14px] font-bold tracking-normal text-white uppercase" style={{ textDecoration: "underline", textUnderlineOffset: "6px", textDecorationThickness: "1px" }}>Quick Links</span></div>
                <a
          ...
          {isAdmin && (
            <div className="px-3 pt-3 pb-1" style={{ borderTop: "1px solid rgba(255,255,255,0.12)" }}>
              {/* Section label */}
              <div className="px-3 mb-2"><span className="text-[14px] font-bold tracking-normal text-white uppercase" style={{ textDecoration: "underline", textUnderlineOffset: "6px", textDecorationThickness: "1px" }}>Admin Tools</span></div>
              <NavLink
                {...adminItem}
