...
## WAVV Watermarking (Session — Jun 4 2026)

- [x] Generate WAVV ///W transparent watermark PNG and upload to static storage
- [x] Add WAVV watermark CSS overlay to Academy video player (AcademyCategory.tsx)
- [x] Add WAVV watermark CSS overlay to Webinars video player (Webinars.tsx)
- [x] Add WAVV watermark CSS overlay to LessonViewer video player (LessonViewer.tsx)
- [x] Install pdf-lib and create server/watermark.ts helper (header band + footer ///W mark)
- [x] Wire PDF watermarking into adminUploadLessonFile (Academy lesson attachments)
- [x] Wire PDF watermarking into adminUploadSectionResource (Academy section PDFs)
- [x] Wire PDF watermarking into guides.uploadFile (Guides & Docs)
- [x] Add Document Type dropdown to all 3 PDF upload forms in Admin.tsx
- [x] Add Skip Watermark checkbox to all 3 PDF upload forms (for 3rd-party content)
